...
function biance() {
    ...
    setInterval(async () => {
        ...
        if (BTC_USDT.statusCode === 200 && ETH_USDT.statusCode === 200 && ETH_BTC.statusCode === 200) {
            ...
            console.log(`...................................................................................`)
            console.log(`BTC_USDT_Bids: ${BTC_USDT_Bids}, ETH_USDT_Asks: ${ETH_USDT_Asks}, ETH_BTC_Bids: ${ETH_BTC_Bids}`)
            console.log(`Cost 1 ETH -> ${ETH_BTC_Bids} BTC -> ${BTC_USDT_Bids * ETH_BTC_Bids} USDT -> ${BTC_USDT_Bids * ETH_BTC_Bids / ETH_USDT_Asks} ETH `)
            console.log(`Profit and loss: ${(BTC_USDT_Bids * ETH_BTC_Bids / ETH_USDT_Asks - 1).toFixed(8)} ETH, ${((BTC_USDT_Bids * ETH_BTC_Bids / ETH_USDT_Asks - 1) / 1 * 100).toFixed(5)}%`)
